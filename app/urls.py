...
from .views import (result_detail,result_detail_hausa,result_detail_arabic,result_detail_french,result_detail_igbo,result_detail_swahili,result_detail_yoruba,fact1,index,chat,report,hausa,igbo, yoruba,french,habout,hausa_result,yabout,
                    ...
                    reliable_sources,yoruba_result,igbo_result,french_result,
...
urlpatterns = [
    ...
    path('result/<slug:slug>/', result_detail, name='result_detail'),
    ...
    path('api/factcheck/', FactcheckAPI.as_view(), name='factcheck_api'),
